...
namespace WpfApp2
{
    ...
    public partial class newwpfEntities : DbContext
    {

        private static newwpfEntities _bd;
        public static newwpfEntities funcbd() {
            if (_bd == null) 
            _bd= new newwpfEntities();
            return _bd; }

        public newwpfEntities()
            : base("name=newwpfEntities")
        {
        }
        ...
        public virtual DbSet<saddnes> saddnes { get; set; }
